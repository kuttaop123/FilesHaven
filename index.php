...
#section .image {
    ...
    height:70vh;
    width:70vh; /* Smooth fade and slide */
    position:absolute;
    margin-top:50px;
    margin-left:50px;
...
@keyframes anything3{
    ...
    100%{
        margin-left:50px;
        background-image: url(images/idk2.png);
    }
}
@keyframes anything4{
    0%{
    ...
    <div class="slider">
        ...
        <div class="list">
            <div class="item active">
                <img src="images/Automated-Upload_Sharing-png.avif">
                <div class="content">
                    <p>FileHaven</p>
                    <h2>Upload!</h2>
                    <p>
            ...
            <div class="item">
                <img src="images/programmers-hand-tapping-on-file-600nw-2450533077.webp">
                <div class="content">
                    <p>FileHaven</p>
                    <h2>Delete!</h2>
                    <p>
            ...
            <div class="item">
                <img src="images/ftpfile-transfer-protocol-files-receiver-600nw-2180917239.webp">
                <div class="content">
                    <p>FileHaven</p>
                    <h2>Download!</h2>
                    <p>
